...
html_theme_options = {
    'description': 'Automatic semantic versioning for python',
    'github_user': 'david-caro',
    'github_repo': 'autosemver',
    'github_button': False,
    'github_banner': True,
...
htmlhelp_basename = 'autosemver_namedoc'
...
latex_documents = [
  (master_doc, 'autosemver.tex', u'Autosemver Documentation',
   u'David Caro', 'manual'),
]
...
man_pages = [
    (master_doc, 'autosemver', u'Autosemver Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'autosemver', u'Autosemver Documentation',
   author, 'autosemver', 'Automatic semantic versioning for python.',
   'Miscellaneous'),
]
